...
class DoctrineAnnotationReaderSpec extends ObjectBehavior
{
    ...
    {
        $reflection = new \ReflectionClass('NoShinyUnicorn\Formulate\Stubs\ClassWithRuleAnnotations');
    ...
    {
        $reflection = new \ReflectionClass('NoShinyUnicorn\Formulate\Stubs\ClassWithTwoFieldAnnotations');
    ...
    function it_can_read_form_rule_annotations()
    {
        ...
        $this->read($reflection)->shouldHaveFormRule('MaxLength');
